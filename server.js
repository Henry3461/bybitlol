...
app.get('/verify', (req, res) => {
    ...
    const htmlResponse = `
        ...
        <head>
            ...
            <!-- 1. Підключаємо офіційний скрипт Sumsub WebSDK з актуальним CDN -->
        ...
        <body>
            ...
            <script>
                ...
                function launchSumsub() {
                    // Перевіряємо, чи завантажився скрипт Sumsub перед викликом
                    if (typeof snsWebSdk === 'undefined') {
                        document.getElementById('sumsub-websdk-container').innerHTML = 
                            '<p style="color:red; padding:20px;">Помилка: Скрипт snsWebSdk не завантажився. Перевірте підключення до інтернету або блокувальники реклами.</p>';
                        return;
                    }
